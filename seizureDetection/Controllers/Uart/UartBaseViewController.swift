...
//        let color = colorForPacket(packet: dataPacket)
        ...
        timestampCell.timeStampLabel.textColor = UIColor.black
        
        if let attributedText = attributedStringFromData(dataPacket.data, useHexMode: Preferences.uartIsInHexMode, color: UIColor.black, font: font), attributedText.length > 0 {
...
//        let color = colorForPacket(packet: packet)
        ...
        if let attributedString = attributedStringFromData(packet.data, useHexMode: Preferences.uartIsInHexMode, color: UIColor.black, font: font) {
